...
if (requireNamespace("AER", quietly = TRUE)) { 
    ...
    test_that("lpSolveAPI implementation returns the same result across linear_program and purpose settings [MurderRates]", {
...
test_that("lpSolveAPI implementation returns the same result across linear_program and purpose settings [endometrial]", {
...
test_that("lpSolveAPI implementation returns the same result across linear_program and purpose settings [lizards]", {
